...
When that observer handles any event with sink `desktop`, it shall not write terminal BEL (`\x07`) or terminal notification escape bytes to orchestrator stdout.
