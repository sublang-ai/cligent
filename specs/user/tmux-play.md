...
When that observer handles `player_finished` or `turn_aborted` with sink `desktop`, it shall not write terminal BEL (`\x07`) or terminal notification escape bytes to orchestrator stdout.
