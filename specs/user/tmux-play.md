...
When the turn ends — by normal completion, ESC abort per [TMUX-057](#tmux-057), or a runtime error — the session shall restore the `boss> ` prompt exactly once, ready for the next Boss turn.
