...
Where a concrete Gemini effort has no model alias from [[gemini-11](../packages/adapters/gemini.md#gemini-11)], or a concrete OpenCode effort has no variant from [OPENCODE-012](adapters/opencode.md#opencode-012), the call shall reject rather than silently ignore the effort.
