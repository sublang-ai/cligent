...
Classify OpenCode deltas by their owning content part so reasoning no longer appears as output or duplicates settled thinking snapshots ([issue #42](https://github.com/sublang-ai/cligent/issues/42)).
