...
End indefinite OpenCode headless waits on permission requests by reproducing OpenCode's native auto response behavior and deterministically resolving any permission request that reaches the adapter ([issue #36](https://github.com/sublang-ai/cligent/issues/36)).

## Deliverables

- [x] [[opencode-7](../packages/adapters/opencode.md#opencode-7)] and
      [[opencode-33](../packages/adapters/opencode.md#opencode-33)] specify
      native auto replies without a session wildcard on the active v1 and v2
      SDK paths.
- [x] [[opencode-20](../packages/adapters/opencode.md#opencode-20)], [[opencode-34](../packages/adapters/opencode.md#opencode-34)], [[opencode-35](../packages/adapters/opencode.md#opencode-35)], [[opencode-36](../packages/adapters/opencode.md#opencode-36)], [[opencode-42](../packages/adapters/opencode.md#opencode-42)], [[opencode-43](../packages/adapters/opencode.md#opencode-43)], and [[opencode-56](../packages/adapters/opencode.md#opencode-56)] specify session-correlated, fail-closed permission replies, bounded reply failure, transport-level abort cleanup, event-count-independent control waits, bounded SDK teardown, and `SIGTERM`-to-`SIGKILL` escalation for headless runs, with a namespaced audit record after successful auto replies.
...
- [x] [[opencode-237](../packages/adapters/opencode.md#opencode-237)] covers both SDK paths, unknown permissions, concurrency, bounded failures, underlying I/O cancellation, and ordered and bounded abort cleanup; [[opencode-55](../packages/adapters/opencode.md#opencode-55)] covers a real `mode: 'auto'` write outside the working directory that proves an explicit `bash` ask was answered `once`.
...
Tasks 1–3 describe the original cohesive implementation; Tasks 4–6 are separate review follow-ups.
Build, typecheck, lint, and unit verification apply at each completed change boundary.
