...
The OpenCode permission hang described below records the posture when this iteration completed.
[[opencode-20](../packages/adapters/opencode.md#opencode-20)] later supersedes that known-hazard disposition by reproducing native auto response behavior: configured rules remain authoritative, surviving asks are answered `once`, and non-auto residual requests receive deterministic fail-closed replies.
