...
The CLI 0.50 contract, joined headless/session arguments, Policy Engine permissions, and isolated live authentication are implemented and verified.
...
- Explicit allowlists remain closed under capability-level allows, disallow rules take precedence, and empty names, wildcards, or invalid TOML string inputs are rejected before spawn.
