...
Give every OpenCode headless run a finite relevant-event liveness boundary, with status-based idle recovery and deterministic cleanup for silent active sessions ([issue #40](https://github.com/sublang-ai/cligent/issues/40)).
