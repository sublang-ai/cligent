...
Replace the released flat token placeholders and the unreleased disjoint breakdown with authentic, coverage-aware, rate-card-oriented usage reports, then use the strongest supported source each coding agent actually exposes.
