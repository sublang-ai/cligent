...
It owns how a portable request becomes a Codex thread and how that thread's stream becomes unified events, permission profiles, thread continuity, and token accounting, not what a caller does with them and not the SDK's own behavior.
