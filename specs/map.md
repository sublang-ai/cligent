...
| Group | File | Summary |
| --- | --- | --- |
| user | [tmux-play.md](user/tmux-play.md) | tmux-play CLI, YAML config, discovery and auto-create, Captain contract, records, observers, topology, theme, speaker colors, tool lifecycle, runtime API, fanout |
