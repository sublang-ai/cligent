...
| `CLAUDE-012` | `engine-55` |
| `CLAUDE-012` | `engine-56` |
| `CLAUDE-012` | `engine-57` |
| `CLAUDE-012` | `engine-58` |
| `CLAUDE-012` | `engine-59` |
| `CLAUDE-012` | `engine-61` |
| `CLAUDE-012` | `engine-62` |
| `CLAUDE-012` | `engine-63` |
| `CLAUDE-012` | `engine-65` |
| `CODEX-001` | `codex-1` |
| `CODEX-002` | `codex-2` |
| `CODEX-002` | `codex-8` |
| `CODEX-002` | `codex-18` |
...
| `CODEX-017` | `engine-59` |
| `GEMINI-001` | `gemini-1` |
| `GEMINI-001` | `gemini-18` |
| `GEMINI-002` | `gemini-2` |
| `GEMINI-003` | `gemini-3` |
| `GEMINI-003` | `gemini-19` |
| `GEMINI-004` | `gemini-4` |
| `GEMINI-004` | `gemini-20` |
| `GEMINI-004` | `gemini-21` |
| `GEMINI-004` | `gemini-22` |
| `GEMINI-004` | `gemini-23` |
| `GEMINI-004` | `gemini-24` |
...
| `GEMINI-006` | `gemini-14` |
| `GEMINI-006` | `gemini-29` |
| `GEMINI-006` | `gemini-30` |
| `GEMINI-006` | `gemini-32` |
| `GEMINI-006` | `gemini-33` |
| `GEMINI-007` | `gemini-7` |
| `GEMINI-007` | `gemini-43` |
| `GEMINI-008` | `gemini-8` |
| `GEMINI-008` | `gemini-44` |
| `GEMINI-009` | `gemini-9` |
| `GEMINI-009` | `gemini-43` |
| `GEMINI-010` | `gemini-10` |
| `GEMINI-011` | `gemini-11` |
| `GEMINI-011` | `gemini-34` |
| `GEMINI-011` | `gemini-35` |
| `GEMINI-012` | `gemini-12` |
| `GEMINI-013` | `gemini-13` |
| `GEMINI-013` | `gemini-31` |
| `GEMINI-014` | `gemini-14` |
| `GEMINI-014` | `gemini-35` |
| `GEMINI-015` | `gemini-15` |
| `GEMINI-016` | `gemini-16` |
| `GEMINI-017` | `gemini-17` |
| `GEMINI-017` | `gemini-35` |
| `GEMINI-017` | `gemini-36` |
| `GEMINI-017` | `gemini-37` |
| `GEMINI-017` | `gemini-38` |
| `GEMINI-017` | `gemini-39` |
| `GEMINI-017` | `gemini-40` |
| `GEMINI-017` | `gemini-41` |
| `GEMINI-017` | `gemini-42` |
| `KIMI-001` | `kimi-1` |
| `KIMI-002` | `kimi-2` |
| `KIMI-003` | `kimi-3` |
| `KIMI-003` | `kimi-14` |
...
| `OPENCODE-002` | `opencode-22` |
| `OPENCODE-003` | `opencode-3` |
| `OPENCODE-003` | `opencode-23` |
| `OPENCODE-004` | `opencode-4` |
| `OPENCODE-005` | `opencode-5` |
| `OPENCODE-005` | `opencode-24` |
| `OPENCODE-005` | `opencode-26` |
...
| `OPENCODE-007` | `opencode-31` |
| `OPENCODE-007` | `opencode-32` |
| `OPENCODE-007` | `opencode-33` |
| `OPENCODE-008` | `opencode-8` |
| `OPENCODE-008` | `opencode-36` |
| `OPENCODE-008` | `opencode-42` |
| `OPENCODE-009` | `opencode-9` |
| `OPENCODE-009` | `opencode-35` |
| `OPENCODE-009` | `opencode-39` |
| `OPENCODE-009` | `opencode-43` |
| `OPENCODE-010` | `opencode-10` |
| `OPENCODE-010` | `opencode-36` |
| `OPENCODE-011` | `opencode-11` |
| `OPENCODE-011` | `opencode-25` |
| `OPENCODE-012` | `opencode-12` |
| `OPENCODE-012` | `opencode-44` |
| `OPENCODE-013` | `opencode-13` |
| `OPENCODE-013` | `opencode-15` |
| `OPENCODE-013` | `opencode-33` |
| `OPENCODE-014` | `opencode-14` |
| `OPENCODE-015` | `opencode-15` |
| `OPENCODE-016` | `opencode-16` |
| `OPENCODE-017` | `opencode-17` |
| `OPENCODE-018` | `opencode-18` |
| `OPENCODE-018` | `opencode-36` |
| `OPENCODE-018` | `opencode-37` |
| `OPENCODE-018` | `opencode-38` |
| `OPENCODE-018` | `opencode-39` |
| `OPENCODE-018` | `opencode-40` |
| `OPENCODE-018` | `opencode-41` |
| `OPENCODE-018` | `opencode-42` |
| `OPENCODE-018` | `opencode-43` |
...
| `OPENCODE-021` | `opencode-46` |
| `OPENCODE-021` | `opencode-47` |
| `OPENCODE-021` | `opencode-48` |
| `OPENCODE-021` | `opencode-49` |
| `OPENCODE-021` | `opencode-50` |
| `OPENCODE-021` | `opencode-51` |
| `ENG-001` | `engine-1` |
| `ENG-002` | `engine-2` |
| `ENG-003` | `engine-3` |
| `ENG-004` | `engine-4` |
...
| `TMUX-048` | `tmux-play-195` |
| `TMUX-048` | `tmux-play-199` |
...
| `TMUX-072` | `tmux-play-16` |
| `TMUX-072` | `tmux-play-40` |
| `TMUX-072` | `tmux-play-69` |
...
| `TTMUX-031` | `tmux-play-130` |
| `TTMUX-031` | `tmux-play-131` |
| `TTMUX-032` | `tmux-play-130` |
| `TTMUX-032` | `tmux-play-132` |
| `TTMUX-033` | `tmux-play-130` |
| `TTMUX-033` | `tmux-play-133` |
| `TTMUX-034` | `tmux-play-130` |
| `TTMUX-034` | `tmux-play-134` |
| `TTMUX-035` | `tmux-play-130` |
| `TTMUX-035` | `tmux-play-135` |
| `TTMUX-035` | `tmux-play-200` |
| `TTMUX-036` | `tmux-play-130` |
...
| `TTMUX-062` | `tmux-play-130` |
| `TTMUX-062` | `tmux-play-162` |
| `TTMUX-063` | `tmux-play-130` |
...
| `TTMUX-069` | `tmux-play-130` |
| `TTMUX-069` | `tmux-play-169` |
| `TTMUX-070` | `tmux-play-130` |
| `TTMUX-070` | `tmux-play-159` |
| `TTMUX-070` | `tmux-play-170` |
| `TTMUX-071` | `tmux-play-171` |
| `TTMUX-073` | `tmux-play-173` |
| `TTMUX-074` | `tmux-play-130` |
...
| `TTMUX-092` | `tmux-play-150` |
| `TTMUX-092` | `tmux-play-192` |
| `TTMUX-093` | `tmux-play-150` |
| `TTMUX-093` | `tmux-play-193` |
| `TTMUX-096` | `tmux-play-150` |
| `TTMUX-096` | `tmux-play-196` |
| `TTMUX-096` | `tmux-play-203` |
| `TTMUX-097` | `tmux-play-150` |
| `TTMUX-097` | `tmux-play-197` |
| `TTMUX-098` | `tmux-play-130` |
...
5. Retiring `META-26` is approved, and with it the amendment to the released-ID clause of [`meta.md`](../meta.md) that admits a retirement at all, the current generation having dropped the item deliberately, so no successor is written and its observability-and-negative-case demand does not return.
   ...
   The GEARS clauses [[meta-6](../meta.md#meta-6)] and the one-requirement rule [[meta-29](../meta.md#meta-29)] are therefore the only shape an item must take, and the dead `meta-26` citation loses its target for good.
