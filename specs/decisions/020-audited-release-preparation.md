...
- Any commit added to the intended release after that final preparation invalidates the boundary and requires a new final release-preparation commit before tagging.
...
- Review follow-ups may land before a release, but the last such follow-up becomes the audited parent of a refreshed final release-preparation commit rather than silently falling outside the record.
