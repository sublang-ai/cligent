...
- Upstream `claude-opus-4-8` SDK behavior/availability; a rejected identifier surfaces as a normal adapter error per [CLAUDE-002](../user/adapters/claude-code.md#claude-002).
