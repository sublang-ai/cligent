...
- [ ] `specs/user/tmux-play.md` — add [TMUX-075](../user/tmux-play.md#tmux-075); amend [TMUX-037](../user/tmux-play.md#tmux-037) and [TMUX-057](../user/tmux-play.md#tmux-057) with the reconciling cross-references.
- [ ] `specs/test/tmux-play.md` — add [TTMUX-074](../test/tmux-play.md#ttmux-074) with the `Verifies:` line.
- [ ] `specs/map.md` — confirm IR-025 is indexed; extend the TMUX user and test summary lines for active-turn prompt suspension.
...
1. [ ] **Spec items + map.** Add [TMUX-075](../user/tmux-play.md#tmux-075); amend [TMUX-037](../user/tmux-play.md#tmux-037) and [TMUX-057](../user/tmux-play.md#tmux-057); add [TTMUX-074](../test/tmux-play.md#ttmux-074); confirm IR-025 indexed in `specs/map.md` and extend the TMUX user/test summary lines. Single docs-only commit.
