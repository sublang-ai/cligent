...
- Spec items: new tmux-play-80..tmux-play-84 and tmux-play-179..tmux-play-185; amendments to tmux-play-64, tmux-play-28, tmux-play-16, tmux-play-17, tmux-play-20, tmux-play-21, tmux-play-10, tmux-play-11; `specs/map.md` package-summary refresh.
...
- [x] `specs/user/tmux-play.md` — amend tmux-play-64 (weight vocabulary), tmux-play-28 (visible-column shape from the visible set), tmux-play-10 (migration rewrite), tmux-play-11 (default canonical weight field), tmux-play-16 / tmux-play-17 (`setVisiblePlayers`), tmux-play-20 / tmux-play-21 (`player_view_changed` enumeration + `turnId`); add tmux-play-80 (`layout.initialVisible`), tmux-play-81 (`setVisiblePlayers` validation / rejection / scope-`turnId`), tmux-play-82 (`player_view_changed` record + non-participating-observer rule), tmux-play-83 (`LayoutObserver` full-rebuild semantics), tmux-play-84 (hidden-pane scrollback limitation).
