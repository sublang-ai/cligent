...
- [ ] `specs/user/tmux-play.md` — add TMUX-067 (wrap-correct Boss input rendering, no scrollback duplication).
- [ ] `specs/test/tmux-play.md` — add TTMUX-067 (real-tmux no-duplication acceptance with ESC + paste regression).
- [ ] `specs/map.md` — index IR-024; extend the TMUX user-summary line.
...
1. [ ] **Spec items + map.** Add TMUX-067 and TTMUX-067; index IR-024 in `specs/map.md`; extend the TMUX user-summary line. Docs-only commit.
