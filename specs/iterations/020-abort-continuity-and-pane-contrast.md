...
- [x] `specs/packages/adapters/{claude-code,codex,gemini,opencode}.md` — amend claude-code-26 / codex-6 / gemini-9 / opencode-11 with the interrupt-token clause.
...
- [x] `specs/user/tmux-play.md` — amend tmux-play-33 / tmux-play-41 (interrupted result exposure), tmux-play-42 (fanout recovery for tokenless aborts), tmux-play-48 (pane-border row surface continuity), and tmux-play-54 (timer color contrast).
...
1. [x] **Spec items + map.** Amend the four adapter user items and tmux-play-48 / tmux-play-54; add the new TADAPT item; index IR-020 in `specs/map.md`. Single docs-only commit.
