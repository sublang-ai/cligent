...
- [x] `specs/packages/adapters/claude-code.md` and `specs/user/adapters/{codex,gemini,opencode}.md` — amend claude-code-7 / CODEX-006 / GEMINI-009 / OPENCODE-011 with the interrupt-token clause.
