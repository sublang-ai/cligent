...
The success path's existing claude-code-210 / codex-211 / TADAPT-012 / gemini-213 coverage stays valid; only the interrupt path needs new verification.
...
- [x] `specs/packages/adapters/{claude-code,codex,gemini}.md` and `specs/user/adapters/opencode.md` — amend claude-code-7 / codex-6 / gemini-9 / OPENCODE-011 with the interrupt-token clause.
