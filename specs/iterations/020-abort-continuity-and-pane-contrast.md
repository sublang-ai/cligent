...
The success path's existing claude-code-210 / TADAPT-011 / TADAPT-012 / TADAPT-013 coverage stays valid; only the interrupt path needs new verification.
...
- [x] `specs/packages/adapters/{claude-code,codex}.md` and `specs/user/adapters/{gemini,opencode}.md` — amend claude-code-7 / codex-6 / GEMINI-009 / OPENCODE-011 with the interrupt-token clause.
