...
This rationale lives in the IR rather than [[tmux-play-64](../packages/tmux-play.md#tmux-play-64)] because the constraint is observable user behavior but its origin is implementation logic (per [META-24](../meta.md#meta-24)).
