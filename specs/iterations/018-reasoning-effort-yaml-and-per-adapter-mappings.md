...
- [x] `specs/packages/adapters/gemini.md` — gemini-11 rewritten with the per-run settings-file mechanism + Gemini 3 / Gemini 2.5 mapping tables; references added.
