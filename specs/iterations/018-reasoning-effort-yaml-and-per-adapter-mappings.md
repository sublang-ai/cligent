...
- [x] `specs/user/adapters/opencode.md` — OPENCODE-012 rewritten with the v2 prompt-body top-level `variant` mechanism + per-provider mapping table; reference added.
