...
8. [x] Tmux presenter: route role records to role logs, Captain/Boss records to the Boss/Captain pane; consume `captain_status`; ignore `captain_telemetry` (it is for opt-in observers, not the Boss pane).
